...
import Laboratorio4_epy_block_0 as epy_block_0  # embedded python block
import math
import sip
import threading
...
class Laboratorio4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Laboratorio4")
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 2, 3000))), True)
        ...
        self.connect((self.epy_block_0, 0), (self.qtgui_const_sink_x_1, 0))
...
def main(top_block_cls=Laboratorio4, options=None):
